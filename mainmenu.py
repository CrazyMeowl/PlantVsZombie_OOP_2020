...
try:
	...
	#soundv.set_sound(sound.SOUND_TYPE_CLICK_MOUSE, 'Resources/sound_track/doubleClick.mp3' )
	soundv.set_sound(sound.SOUND_TYPE_WIDGET_SELECTION, 'Resources/sound_track/butter_openmenu.mp3')
	 
	menu.add_button('Play Trial', start_the_game)
	menu.add_button('Option', option_the_game)
	menu.add_button('?!? Quit ?!?', pygame_menu.events.EXIT)
	menu.set_sound(soundv, recursive=True)
